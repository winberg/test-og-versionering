...
public class TjekMontorFkt
{
	public static void main(String[] arg)
	{
		...
		System.out.println("*** Tjek af, at det kun er montøren der kan bruge montørfunktionerne");
		automat.montørLogin("");
		automat.setBilletpris(2);
		if (automat.getBilletpris() == 2) {
			System.out.println("FEJL, det skal ikke være muligt at ændre prisen uden at være logget ind");
			antalFejl = antalFejl + 1;
		}
